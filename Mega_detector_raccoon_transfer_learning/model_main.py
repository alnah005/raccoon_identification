...
flags.DEFINE_integer( 'save_checkpoints_secs', 3600, 'Checkpoint every n secs')
...
def main(unused_argv):
  ...
  # config = tf.estimator.RunConfig(model_dir=FLAGS.model_dir, session_config=session_config,save_checkpoints_secs=FLAGS.save_checkpoints_secs,save_checkpoints_steps=2000)
  config = tf.estimator.RunConfig(model_dir=FLAGS.model_dir, session_config=session_config,save_checkpoints_steps=2000)
